---
tags: [business-studies, hsc, year-12, moc, index]
subject: Business Studies
syllabus_ref: HSC Business Studies — All Topics
created: 2026-05-17
updated: 2026-05-18
---

# Business Studies — Map of Content

> **Master index** for all HSC Business Studies notes in the Brain vault.
...
### Exam Preparation
- [[HSC_Exam_Technique_and_Model_Answers]] — Command words, response scaffolds, model answers
...
| Task | Subject | Topic | Status |
|------|---------|-------|--------|
| Task 1 (2025) | Finance | McDonald's financial analysis | ✅ Model answers captured |
| Task 2 (2026) | Finance | Apple financial performance report | ✅ Apple data captured |
| Ops & Marketing Report | Operations + Marketing | Perfect Fresh case study | ✅ Scaffold captured |
| Ratios & Strategies Activities | Finance | Cash flow, profitability, liquidity, gearing, efficiency | ✅ Full activities captured |
...
- **Interdependence** — all four functions are interconnected
- **Stakeholders** — employees, customers, shareholders, government, community
- **Globalisation** — impacts all four functions
- **Technology** — transforming all business functions
- **Ethics and corporate social responsibility** — increasing importance
- **Legal compliance** — Corporations Act, Fair Work Act, CCA, WHS Act

---

## HSC Exam Tips

1. **Always apply theory to a case study** — don't just describe, link to real business
2. **Use specific data** — ratios, figures, dates, percentages
3. **Show interdependence** — connect functions in extended responses
4. **Know your verbs** — identify (1-2 marks), explain (3-4 marks), evaluate (7-8 marks)
5. **Practice time management** — 3 hours for 100 marks

---

> **Vault:** Brain (raw knowledge) → polished to Final vault for exam revision
