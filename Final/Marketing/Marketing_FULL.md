---
title: Marketing — Full Module Note
subject: Business Studies
type: final
unit: HSC
syllabus_topic: Marketing
section: Full
tags:
  - business-studies
  - marketing
...
# 📕 Marketing — Full Module Note

> **The whole module in one file.** Split versions: [[Marketing_1_Role|① Role]] · [[Marketing_2_Influences|② Influences]] · [[Marketing_3_Processes|③ Processes]] · [[Marketing_4_Strategies|④ Strategies]]

> **Scope:** the full HSC Marketing module is examinable.
...
|---|---|
| **Operations** | Marketing provides demand forecasts and customer preferences → operations modifies production. Operations produces goods → marketing sells them |
...
|---|---|---|
| **Production** | Consumers buy based on product quality | Taking orders and delivering products |
| **Sales** | Increased competition requires aggressive selling | Advertising to stimulate demand |
...
| Practice | Definition |
|---|---|
| **Concealed facts** | Omitting information that could harm trust |
| **Puffery** | Exaggerated claims no reasonable person would take as factual |
| **Vague statements** | Ambiguous words consumers misinterpret |
...
- Error 53 — staff misled customers about repair rights
- Consumer guarantee representations — ACCC took action
- Apple gave undertaking to improve policies

**Woolworths:**

- ACCC court case over misleading grocery pricing/discount practices
...
| Objective | Strategy |
|---|---|
| **Increase market share** | Promotional campaigns, competitive pricing, product differentiation |
...
> ⚠️ **Syllabus placement.** Only *"identifying target markets"* is a **marketing process** dot point (step 4). *"Market segmentation, product/service differentiation and positioning"* is the **first dot point under marketing strategies** (§4). They are grouped here for teaching, but in an exam a **"marketing strategies"** question expects segmentation and positioning.
...
> ⚠️ **Positioning is a marketing STRATEGY in the syllabus**, not a process. See the note at §3.6. **Product/service differentiation** belongs with it: making a similar product *appear different from and better than* competitors', which gives the seller control over price.
...
| P | Definition | Apple Example |
|---|---|---|
| **People** | Quality of customer-employee interaction | "Genius" and "Specialist" job titles; strong sales/customer service training; in-store, online, phone support |
| **Processes** | Flow of activities in service delivery | Online ordering; free iOS upgrades; pre-ordering; roaming payment systems in stores |
| **Physical evidence** | Environment where service is delivered + tangible brand materials | Stores designed for innovation/quality; hands-on "test-drive" approach; prime city locations; sleek packaging; professional website |
...
- **"Accelerating the Arches"** (2020) → **"Accelerating the Arches 2.0"** (2023)
- Focus: maximise marketing, brand and affordability
...
| **Sociocultural** | China middle class expansion: 80M (2002) → 500M+ (2024) = more disposable income |
| **Economic** | Rising inflation increases input costs; efficiency gains to offset (can't always raise prices) |
| **Government** | UK Calorie Labelling Regulations (2022) — mandatory calorie info at all touchpoints |

### Consumer Laws

- **Labelling**: Australia NZ Food Standards Code; NSW Food Act 2003; mandatory kilojoule labelling. 2015 breach: animated menu boards hid kilojoule info. 2018 Cancer Council study: labelling had limited impact on consumer behaviour
- **Advertising**: Quebec forbids advertising to children under 13. 2013 class action — Happy Meal toys timed with films. Settled 2020: $1M donation + changed practices

### Ethical Considerations

- **1997 McLibel case**: McDonald's UK guilty of exploiting children with advertising
- **2020 breach**: TV ad "naughty girl" rewarded with McDonald's — aimed at children, only unhealthy options
- **2023 breach**: "Player of the Week" awards gave children occasional food products (violated voluntary code)
- Part of **Australian Association of National Advertisers** (self-regulatory)

### SWOT

| | |
|---|---|
| **Strengths** | Diversified income; global brand; high-quality standards; growth plan; ~uniform menu; access to capital; large market share; technology |
| **Weaknesses** | Lack of central control over franchises (2023 IT glitch); perception of unhealthiness; multiple jurisdictions |
| **Opportunities** | Innovation/differentiation; reinvest in restaurants; digital media; social/environmental performance; new products |
| **Threats** | Negative publicity; environmental regulations; supply chain interruptions; inflation; competition (BK, Domino's, Starbucks, Wendy's); wage costs; legal complexity |

### Product Life Cycle

- **Burgers** = mature; **Chicken & coffee** = growth
- **French fries**: Introduction (1940s) → Growth (1940s–1990) → Maturity (1990, recipe change due to health campaign, share price fell) → Renewal (Loaded, Twisted, Waffle, Cheesy Bacon fries)

### Market Research

- Traditional: surveys, questionnaires, sales data
- Modern: apps provide **real-time data** (what sells, when, where, to whom)
- **AI-powered dynamic pricing**: adjusts menu prices, tests consumer price resistance
...
| **Psychographic** | Interests, attitudes, values, lifestyles; data-driven personalised segmentation |
| **Behavioural** | Loyalty, purchase frequency, transaction value; paper cards → app-only loyalty (2019); rewards points; predict future patterns |
| **Geographic** | Malaysian soup, McAloo Tikki (India), Teriyaki Mac (Japan), Prosperity Burger (Chinese New Year) |

### Product Strategies

- COVID simplified menu → **core products = ~70% of sales** in top 6 markets
- **Branding**: Golden arches more recognisable than the Christian cross; 17 "billion-dollar brands"; Big Mac alone >US$1B
...
| **Price points** | "Value ladder" from Loose Change → Standard → Gourmet (Chicken Deluxe) |
| **Price bundling** | McValue Meals — Big Mac meal $13.35 = 14% saving vs individual items |
| **AI pricing** | Dynamic pricing models test consumer price resistance at different stores |

### Promotion

- **US$4 billion/year** on promotion worldwide; 3rd largest ad spender in Australia
- Regional "co-ops" for local advertising; shift from advertising to **engaging**
- **2022 FIFA World Cup**: Largest global campaign — McDelivery in 75 countries, 10 languages; double-digit delivery sales increases
- **Publicity**: Negative — Super Size Me, McLibel, China meat scandal, McMillion$, Israeli soldiers (2024)
- **Sales promotions**: FIFA World Cup — yellow/red card = free items in Canada

### Place/Distribution

- **Producer → Retailer → Customer** channel; ~42,000 restaurants; selective distribution
- **Delivery**: 55,000 orders at any moment; US$16B delivery sales (2023)
- Focus on **Drive-Thru** expansion
...
### Answering "Assess" on Promotional Mix

**"Assess why a promotional mix is important in marketing goods and services"**

- **Assess** = judgement of value and importance
- Structure: Intro (define + case studies) → 3 body paragraphs (one per strategy) → Conclusion (restate judgement + link to business goal)
...
- **E:** Apple uses online ordering, pre-orders, roaming payment systems, free iOS upgrades.
- **E:** These processes reduce waiting times, improve convenience, and reflect Apple's innovative brand image. Efficient processes help Apple provide seamless customer experience.
- **L:** Therefore, Apple's target market strongly influences its processes, maintaining customer satisfaction, loyalty, and competitive advantage.
...
- Specific case study examples (Apple, McDonald's, BYD, etc.)
- Business terminology from the syllabus
- Cause-and-effect reasoning (how → therefore → which leads to)
- Links to business goals (profit maximisation, growth, competitive advantage)
...
|---|---|
| Marketing | Total system to plan, promote, price and distribute products |
| Marketing plan | Actions and strategies to attain greater sales |
| Marketing objectives | Realistic, measurable goals from the marketing plan |
| Target market | Group of customers a business intends to sell to |
| Market segmentation | Dividing a market into distinct similar-characteristic groups |
...
| Market research | Systematic collection and analysis of marketing information |
| Primary data | First-hand data collected by the business |
| Secondary data | Others' research (Census, industry reports) |
| Market share | Company sales ÷ total industry sales × 100 |
...
> **See also:** [[Finance_FULL|Finance]] | [[Operations_FULL|Operations]] | [[Human_Resources_FULL|Human Resources]] | [[Case_Studies]] | [[MOC]]
